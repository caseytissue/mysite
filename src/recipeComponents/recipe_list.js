export const listOfRecipes = [
  ...
  },
  {
    ...
    instructions:["Preheat oven to 400 degrees F, and grease a 9 inch pie dish", "Heat oil in skillet, and add the ground beef, salt, and pepper. Cook beef until fully cooked, breaking it up as it cooks", "Remove from heat and stir in sauces", "Transfer the meat mixture to the perpared pie plate and top with bacon and cheese", "Whisk together eggs, milk, salt, and pepper, and pour over the meat and cheese in the pie plate", "Bake for 30-35 minutes or until egg is cooked through"],
    nutrition:"",
    tags:["cheese", "beef"]
  },
  {
    image:"",
    title:"Protein Baked Oatmeal",
  ...
  },
  {
    ...
    nutrition:"",
    tags:["banana", "oatmeal", "bar", "peanut butter"]
  },
  {
    image:"",
    title:"Gummy Bears",
  ...
  },
  {
    ...
    nutrition:"",
    tags:["chocolate", "raspberry", "bread pudding"]
  },
  {
    image:"",
    title:"Baked Oatmeal",
  ...
  },
  {
    ...
    nutrition:"",
    tags:["cookie", "chocolate", "marshmallow"]
  },
  {
    image:"",
    title:"King Arthur Gluten Free Sugar Cookies",
    ingredients:["1 cup sugar", "1/2 cup (8 tbsp) butter", "1 large egg", "1 tsp vanilla extract", "1 3/4 cup King Arthur Gluten Free Flour", "1/2 cup Almond Flour", "1/2 tsp baking powder", "1/4 tsp salt", "1/2 tsp xanthan gum"],
    instructions:["Lightly grease (or line with parchment) two baking sheets. Preheat the oven to 350 degrees F (for cutout cookies, preheating can be done later).", "Beat the butter and sugar together until fluffy", "Add the egg and vanilla, stir until combined, scraping the sites of the bowl and stirring again", "Add the dry ingredients, stirring just until the dough comes together", "To make drop cookies: Drop the dough by teasponfulls onto the prepared baking sheets, leaving about 1 1/2 inches between them. Bake about 12 minutes; they won't brown, but will feel set.", "For cutout cookies: scoop the dough onto a piece of plastic wrap, flatten it into a disk, and wrap. Refigerate the dough for at least 1 hour. Preheat oven to 350 degress. Remove the dough from refrigerator, dust a flat surface with gluten free flour, and roll the dough about 1/4 inch thick. Cut out cookies in any shape and place them on a baking sheet. Chill them in the frige for 10 minutes before placing in the oven. Bake for 8 to 10 minutes; they won't brown, but will feel set.","Try adding grated rind of 1 orange and 1/4 tsp nutmeg"],
    nutrition:"",
    tags:["King Arthur Flour", "cookie"]
  },
  {
    image:"",
    title:"King Arthur Gluten Free Pie Dough",
    ingredients:["1 1/4 cup King Arthur Gluten Free Flour", "1 tbsp sugar", "2 tsp Instand clearJel (optional)", "1/2 tsp xanthan gum", "1/2 tsp salt", "3/8 cup (6 tbsp) cold butter", "1 large egg", "2 tsp lemon juice or vinegar"],
